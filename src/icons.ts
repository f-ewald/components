...
/** Close, dismiss, or clear (e.g. a modal, toast, or clearable input). */
...
/** A hamburger menu toggle, e.g. collapsing or opening a sidebar/nav drawer. */
...
/** "Previous" navigation, e.g. pagination or carousel back controls. */
...
/** "Next" navigation, or a collapsed disclosure/submenu indicator. */
...
/** "Scroll to top", or an expanded/upward disclosure control. */
...
/** Settings, preferences, or configuration entry points. */
...
/** Neutral informational messages, e.g. an info toast or status banner. */
...
/** Help, tooltips, or "learn more" affordances. */
...
/** Edit actions, e.g. an edit icon-button or inline edit toggle. */
...
/** Delete/remove actions, typically paired with a destructive/danger style. */
...
/** An overflow ("kebab") menu trigger, e.g. dropdown-button's icon variant. */
...
/** Collapsed items in an inline sequence, e.g. breadcrumb-nav's truncated middle. */
export const iconEllipsisHorizontal = (size = 16) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM18.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z"/></svg>`;

/** "Add new" actions, e.g. creating a new item or row. */
...
/** A list-view toggle, or to represent list-type content. */
...
/** Monetary values, pricing, or billing-related content. */
...
/** A primary navigation link to the app's home or dashboard. */
...
/** A location, address, or map marker. */
...
/** Timestamps, durations, or time-related metadata. */
...
/** Tags, labels, or categorical metadata. */
...
/** Dates, due dates, or calendar-related metadata. */
...
/** "Expand" or "view fullscreen" actions. */
...
/** A map-view toggle, or to represent map/geographic content. */
...
/** Success states, confirmations, or a selected-item checkmark. */
...
/** A light-theme toggle, or to represent daytime/light mode. */
...
export const iconSparkles = (size = 16) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM16.894 20.567 16.5 21.75l-.394-1.183a2.25 2.25 0 0 0-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 0 0 1.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 0 0 1.423 1.423l1.183.394-1.183.394a2.25 2.25 0 0 0-1.423 1.423Z"/></svg>`;

/** Security warnings, or at-risk/compromised states. */
...
/** Refresh actions, or an animated busy/loading spinner. */
...
/** "Continue" or forward-progressing actions, e.g. a compact next-step arrow. */
...
/** Swap, exchange, or compare actions between two items. */
...
/** Hyperlink-related actions or a linked/associated-item indicator. */
...
/** "Like"/"favorite" actions in their unselected state. */
...
/** "Like"/"favorite" actions in their selected/active state; pair with iconHeart for the unselected state. */
...
/** "Show"/"preview" actions or a visible/reviewed state, e.g. password visibility or a review status. */
...
/** "Hide" actions or a hidden/masked state; pair with iconEye for the visible state. */
...
/** Verified, secure, or trusted states. */
...
/** A generic user/person fallback, e.g. user-avatar's icon fallback. */
...
/** Task lists, checklists, or clipboard/notes content. */
...
/** System, hardware, or technical/processing content. */
...
/** Folders, directories, or grouped file content. */
...
/** "Scroll to bottom", a downward disclosure, or an expanded tree/accordion indicator. */
...
/** A generic file/document icon, e.g. tile-grid's default file icon. */
...
/** A grid or kanban-view toggle, or to represent card/tile layouts. */
...
/** Messaging, comments, or conversation-related content. */
...
/** Links that open in a new tab/window, or navigate to an external site. */
...
/** Education, learning, or certification-related content. */
...
/** Queues, backlogs, or ordered work-item lists. */
...
/** Warning states, e.g. the warning variant of toast-notification. */
...
/** Error states, e.g. the error variant of toast-notification. */
...
/** A dark-theme toggle, or to represent night/dark mode. */
...
/** A "system/auto" theme option, or to represent a desktop device. */
...
/** Code snippets, developer tools, or technical/API content. */
...
/** Plugins, integrations, or extensible/add-on features. */
...
/** Teams, groups, or multi-user/collaboration content. */
...
/** Tools, maintenance, or build/configuration actions. */
export const iconWrenchScrewdriver = (size = 18) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z"/></svg>`;

/** "Play" transport actions, e.g. audio-player/video-player's paused state. */
export const iconPlay = (size = 18) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 0 1 0 1.972l-11.54 6.347a1.125 1.125 0 0 1-1.667-.986V5.653Z"/></svg>`;

/** "Pause" transport actions, e.g. audio-player/video-player's playing state. */
export const iconPause = (size = 18) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5"/></svg>`;

/** An unmuted volume control, e.g. audio-player/video-player's mute toggle. */
export const iconSpeakerWave = (size = 18) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M19.114 5.636a9 9 0 0 1 0 12.728M16.463 8.288a5.25 5.25 0 0 1 0 7.424M6.75 8.25l4.72-4.72a.75.75 0 0 1 1.28.53v15.88a.75.75 0 0 1-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.009 9.009 0 0 1 2.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75Z"/></svg>`;

/** A muted volume state; pair with iconSpeakerWave for the unmuted state. */
export const iconSpeakerXMark = (size = 18) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M17.25 9.75 19.5 12m0 0 2.25 2.25M19.5 12l2.25-2.25M19.5 12l-2.25 2.25m-10.5-6 4.72-4.72a.75.75 0 0 1 1.28.53v15.88a.75.75 0 0 1-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.009 9.009 0 0 1 2.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75Z"/></svg>`;

/** "Exit fullscreen" actions; pair with iconArrowsPointingOut for entering fullscreen. */
export const iconArrowsPointingIn = (size = 16) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M9 9V4.5M9 9H4.5M9 9 3.75 3.75M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 9h4.5M15 9V4.5M15 9l5.25-5.25M15 15h4.5M15 15v4.5m0-4.5 5.25 5.25"/></svg>`;

/** Terrain/outdoors content, or a Americas-centric globe/region selector. */
export const iconGlobeAmericas = (size = 16) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m6.115 5.19.319 1.913A6 6 0 0 0 8.11 10.36L9.75 12l-.387.775c-.217.433-.132.956.21 1.298l1.348 1.348c.21.21.329.497.329.795v1.089c0 .426.24.815.622 1.006l.153.076c.433.217.956.132 1.298-.21l.723-.723a8.7 8.7 0 0 0 2.288-4.042 1.087 1.087 0 0 0-.358-1.099l-1.33-1.108c-.251-.21-.582-.299-.905-.245l-1.17.195a1.125 1.125 0 0 1-.98-.314l-.295-.295a1.125 1.125 0 0 1 0-1.591l.13-.132a1.125 1.125 0 0 1 1.3-.21l.603.302a.809.809 0 0 0 1.086-1.086L14.25 7.5l1.256-.837a4.5 4.5 0 0 0 1.528-1.732l.146-.292M6.115 5.19A9 9 0 1 0 17.18 4.64M6.115 5.19A8.965 8.965 0 0 1 12 3c1.929 0 3.716.607 5.18 1.64"/></svg>`;

/** A generic globe/satellite-view toggle, or international/worldwide content. */
export const iconGlobeAlt = (size = 16) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418"/></svg>`;

/** Live/real-time data, connectivity strength, or a traffic-conditions toggle. */
export const iconSignal = (size = 16) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M9.348 14.652a3.75 3.75 0 0 1 0-5.304m5.304 0a3.75 3.75 0 0 1 0 5.304m-7.425 2.121a6.75 6.75 0 0 1 0-9.546m9.546 0a6.75 6.75 0 0 1 0 9.546M5.106 18.894c-3.808-3.807-3.808-9.98 0-13.788m13.788 0c3.808 3.807 3.808 9.98 0 13.788M12 12h.008v.008H12V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z"/></svg>`;

/** Copy-to-clipboard actions, e.g. copy-link-button. */
export const iconClipboard = (size = 18) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 0 1-.75.75H9a.75.75 0 0 1-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 0 1 1.927-.184"/></svg>`;

/** Search inputs or search-triggering actions. */
export const iconMagnifyingGlass = (size = 16) =>
  svg`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="currentColor" width=${size} height=${size} aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"/></svg>`;
