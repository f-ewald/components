...
export class AnimateConfetti extends LitElement {
  ...
  private colors = ["DodgerBlue", "OliveDrab", "Gold", "Pink", "SlateBlue", "LightBlue", "Violet", "PaleGreen", "SteelBlue", "SandyBrown", "Chocolate", "Crimson"]
  ...
  private drawParticles(context: any) {
		var particle;
		var x;
		for (var i = 0; i < this.particles.length; i++) {
			particle = this.particles[i];
  ...
  private resetParticle(particle: any, width: number, height: number) {
